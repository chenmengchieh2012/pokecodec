...
export const AchievementIcons: Record<string, React.ReactNode> = {
    ...
    "11": <IconEarlyBird />,
    "12": <IconSniper />,
    "13": <IconPokedexRookie />,
    "14": <IconPokedexExplorer />,
    "15": <IconPokedexPro />,
    "16": <IconPokedexMaster />,
    "17": <IconKantoChampion />,
    "18": <IconBirdWatcher />,
    "19": <IconBugCatcher />,
    "20": <IconGardener />,
    "21": <IconPyromaniac />,
    ...
    "27": <IconSpooky />,
    "28": <IconDragonTamer />,
    "29": <IconLegendaryHunter />,
    "30": <IconShinyHunter />,
    "31": <IconBattleNovice />,
    "32": <IconBattleVeteran />,
    "33": <IconBattleLegend />,
    "34": <IconSuperEffective />,
    "35": <IconNotVeryEffective />,
    "36": <IconCriticalHit />,
    "37": <IconOneHitWonder />,
    "38": <IconCloseCall />,
    "39": <IconFlawlessVictory />,
    "40": <IconTypeExpert />,
    "41": <IconUnderdog />,
    "42": <IconGiantSlayer />,
    "43": <IconTrainingDay />,
    "44": <IconGettingStronger />,
    "45": <IconPowerhouse />,
    "46": <IconMaxPotential />,
    "47": <IconEvolutionMaster />,
    "48": <IconStoneAge />,
    "49": <IconFriendship />,
    "50": <IconPennyPincher />,
    "51": <IconBigSpender />,
    ...
    "64": <IconDayCare />,
    "65": <IconEggHatcher />,
    "66": <IconSocialButterfly />,
    "67": <IconGymLeader />,
    "68": <IconEliteFour />,
    "69": <IconChampion />,
    "70": <IconCollector />,
    "71": <IconPhotographer />,
    "72": <IconNicknameRater />,
    "73": <IconMoveTutor />,
    "74": <IconMoveDeleter />,
    "75": <IconStrategist />,
    "76": <IconTank />,
    ...
    "79": <IconEscapeArtist />,
    "80": <IconBraveHeart />,
    "81": <IconCompletionist />,
    "82": <IconPerfectionist />,
    "83": <IconSyntaxError />,
    "84": <IconInfiniteLoop />,
    "85": <IconRefactoring />,
    "86": <IconFullStack />,
    "87": <IconMergeConflict />,
    "88": <IconPullRequest />,
    "89": <IconDeploy />,
    "90": <IconWorksOnMyMachine />,
    "91": <IconSpaghettiCode />,
    "92": <IconRubberDuck />,
    "93": <Icon404 />,
    "94": <IconBSOD />,
    "95": <IconCopyPaste />,
    ...
    "97": <IconTechDebt />,
    "98": <IconMemoryLeak />,
    "99": <IconGarbageCollector />,
    "100": <IconSudo />,
    "102": <IconGitBlame />,
    "103": <IconBugFix />,
    "104": <IconCanary />,
    "105": <IconTopPercentage />,
    "106": <IconGodObject />,
    "107": <IconCake />,
    "108": <IconRaceCondition />,
};
